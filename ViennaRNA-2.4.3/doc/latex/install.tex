...
\begin{DoxyVerb}tar -zxvf ViennaRNA-2.4.2.tar.gz
cd ViennaRNA-2.4.2
./configure
make
sudo make install
...
\end{DoxyVerb}
\hypertarget{install_config_swig}{}\subsection{Scripting Interfaces}\label{install_config_swig}
