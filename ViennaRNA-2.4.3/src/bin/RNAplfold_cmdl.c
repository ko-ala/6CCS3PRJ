...
init_full_help_array(void)
{
  ...
  RNAplfold_args_info_full_help[15] = RNAplfold_args_info_detailed_help[16];
  RNAplfold_args_info_full_help[16] = RNAplfold_args_info_detailed_help[18];
  RNAplfold_args_info_full_help[17] = RNAplfold_args_info_detailed_help[20];
  RNAplfold_args_info_full_help[18] = RNAplfold_args_info_detailed_help[22];
  RNAplfold_args_info_full_help[19] = RNAplfold_args_info_detailed_help[24];
  RNAplfold_args_info_full_help[20] = RNAplfold_args_info_detailed_help[26];
  RNAplfold_args_info_full_help[21] = RNAplfold_args_info_detailed_help[28];
  RNAplfold_args_info_full_help[22] = RNAplfold_args_info_detailed_help[30];
  RNAplfold_args_info_full_help[23] = RNAplfold_args_info_detailed_help[31];
  RNAplfold_args_info_full_help[24] = RNAplfold_args_info_detailed_help[32];
  RNAplfold_args_info_full_help[25] = RNAplfold_args_info_detailed_help[33];
  RNAplfold_args_info_full_help[26] = RNAplfold_args_info_detailed_help[35];
  ...
  RNAplfold_args_info_full_help[32] = RNAplfold_args_info_detailed_help[45];
  RNAplfold_args_info_full_help[33] = RNAplfold_args_info_detailed_help[47];
  RNAplfold_args_info_full_help[34] = RNAplfold_args_info_detailed_help[48];
  RNAplfold_args_info_full_help[35] = RNAplfold_args_info_detailed_help[50];
  RNAplfold_args_info_full_help[36] = 0; 
  
}

const char *RNAplfold_args_info_full_help[37];
...
init_help_array(void)
{
  ...
  RNAplfold_args_info_help[14] = RNAplfold_args_info_detailed_help[16];
  RNAplfold_args_info_help[15] = RNAplfold_args_info_detailed_help[30];
  RNAplfold_args_info_help[16] = RNAplfold_args_info_detailed_help[31];
  RNAplfold_args_info_help[17] = RNAplfold_args_info_detailed_help[32];
  RNAplfold_args_info_help[18] = RNAplfold_args_info_detailed_help[33];
  RNAplfold_args_info_help[19] = RNAplfold_args_info_detailed_help[35];
  ...
  RNAplfold_args_info_help[23] = RNAplfold_args_info_detailed_help[43];
  RNAplfold_args_info_help[24] = RNAplfold_args_info_detailed_help[50];
  RNAplfold_args_info_help[25] = 0; 
  
}

const char *RNAplfold_args_info_help[26];
...
void init_args_info(struct RNAplfold_args_info *args_info)
{
  ...
  args_info->auto_id_help = RNAplfold_args_info_detailed_help[14] ;
  args_info->id_prefix_help = RNAplfold_args_info_detailed_help[16] ;
  args_info->id_delim_help = RNAplfold_args_info_detailed_help[18] ;
  args_info->id_digits_help = RNAplfold_args_info_detailed_help[20] ;
  args_info->id_start_help = RNAplfold_args_info_detailed_help[22] ;
  args_info->filename_delim_help = RNAplfold_args_info_detailed_help[24] ;
  args_info->filename_full_help = RNAplfold_args_info_detailed_help[26] ;
  args_info->commands_help = RNAplfold_args_info_detailed_help[28] ;
  args_info->temp_help = RNAplfold_args_info_detailed_help[31] ;
  args_info->noTetra_help = RNAplfold_args_info_detailed_help[32] ;
  args_info->dangles_help = RNAplfold_args_info_detailed_help[33] ;
  args_info->noLP_help = RNAplfold_args_info_detailed_help[35] ;
  args_info->noGU_help = RNAplfold_args_info_detailed_help[37] ;
  args_info->noClosingGU_help = RNAplfold_args_info_detailed_help[38] ;
  args_info->paramFile_help = RNAplfold_args_info_detailed_help[39] ;
  args_info->pfScale_help = RNAplfold_args_info_detailed_help[41] ;
  args_info->binaries_help = RNAplfold_args_info_detailed_help[43] ;
  args_info->nsp_help = RNAplfold_args_info_detailed_help[45] ;
  args_info->energyModel_help = RNAplfold_args_info_detailed_help[47] ;
  args_info->betaScale_help = RNAplfold_args_info_detailed_help[48] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVW:L:c:ou:OT:4d:P:S:be:", long_options, &option_index);
