...
.  */
 ...
 help description.  */
  double pfScale_arg;	/**< @brief In the calculation of the partition function use pfScale * average_free_energy as an estimate for the ensemble free energy (used to avoid overflows).
.  */
  char * pfScale_orig;	/**< @brief In the calculation of the partition function use pfScale * average_free_energy as an estimate for the ensemble free energy (used to avoid overflows).
 original value given at command line.  */
  const char *pfScale_help; /**< @brief In the calculation of the partition function use pfScale * average_free_energy as an estimate for the ensemble free energy (used to avoid overflows).
 help description.  */
